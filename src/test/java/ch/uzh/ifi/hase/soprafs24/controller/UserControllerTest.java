...
public class UserControllerTest {
    ...
    public void getUserWithId_validInput_valid() throws Exception {
        ...
        // when/then -> do the request + validate the result
        MockHttpServletRequestBuilder getRequest = get("/users/" + userId.toString()).header("Authorization", token);
    ...
    public void postUserWithId_validInput_invalid() throws Exception {
        ...
        given(userService.getUserById(Mockito.any(Long.class))).willThrow(new NotFoundException("not found"));
